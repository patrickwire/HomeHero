          ...
          <div className="ProfilePic">
            ...
            <div className="User">
              ...
              <div className="Userpoints">
                <b>9.999</b>
                <img style={{height: '32px', paddingLeft: '7px'}} src={icon_star_purple}></img>
              </div>
        ...
        <div className="SVGContainer">
            <div className="Social">
                 ...
                 <div className="PointContainer">
                    <div className="Points"><b>9.999</b></div>
                    <div className="Nameline">AKTIV</div>
                 </div>
                 <div className="Star"><img style={{height: '16px'}} src={icon_star_white}></img></div>
            </div>
